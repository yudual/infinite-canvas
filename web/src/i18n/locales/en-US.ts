export default {
    ...
    canvas: {
        ...
        export: { defaultProjectName: "Yu-canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
